...
Status.propTypes = {
    ...
    text: _react.PropTypes.shape({
        ...
        paused: _react.PropTypes.string,
        queued: _react.PropTypes.string,
        retrying_upload: _react.PropTypes.string,
        submitting: _react.PropTypes.string,
        uploading: _react.PropTypes.string,
        upload_failed: _react.PropTypes.string,
        upload_successful: _react.PropTypes.string
    }),
