...
var Gallery = function (_Component) {
    ...
    _createClass(Gallery, [{
        ...
        value: function componentDidMount() {
            ...
            this.setState({
                visibleFiles: this.props.uploader.methods.getUploads().filter(function (x) {
                    return x.status === 'upload successful';
                }).map(function (x) {
...
var MaybeDropzone = function MaybeDropzone(_ref2) {
    ...
    if (hasVisibleFiles) {
        ...
        content = content || getDefaultMaybeDropzoneContent({ content: content, disabled: disabled });
    }
...
var isFileGone = function isFileGone(status) {
