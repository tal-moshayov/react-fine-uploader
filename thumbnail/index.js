...
var Thumbnail = function (_Component) {
    ...
    _createClass(Thumbnail, [{
        ...
        value: function componentDidMount() {
            ...
            this.props.uploader.methods.drawThumbnail(this.props.id, this.refs.canvas, this.props.maxSize, this.props.fromServer).then(function () {
                _this2.setState({
                    drawComplete: true,
                    success: true
                });
...
Thumbnail.propTypes = {
    ...
    notAvailablePlaceholder: _react.PropTypes.element,
    uploader: _react.PropTypes.object.isRequired,
    waitingPlaceholder: _react.PropTypes.element
};
