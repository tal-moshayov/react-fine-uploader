...
var RetryButton = function (_Component) {
    ...
    function RetryButton() {
        ...
        var _this = _possibleConstructorReturn(this, (RetryButton.__proto__ || Object.getPrototypeOf(RetryButton)).call(this));
        ...
        _this._onStatusChange = function (id, oldStatus, newStatus) {
            if (id === _this.props.id && !_this._unmounted && newStatus === 'retrying upload') {
                _this.setState({ retryable: false });
            }
        };
...
RetryButton.propTypes = {
    ...
    onlyRenderIfRetryable: _react.PropTypes.bool,
