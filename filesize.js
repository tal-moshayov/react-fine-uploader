...
Filesize.propTypes = {
    ...
    units: _react.PropTypes.shape({
        byte: _react.PropTypes.string,
        kilobyte: _react.PropTypes.string,
        megabyte: _react.PropTypes.string,
        gigabyte: _react.PropTypes.string,
        terabyte: _react.PropTypes.string
    }),
